...
public class Util {
  ...
  /**
   * Adds a String to a new Line in an items lore.
   */
  ...
  /**
   * Compares a Bukkit Recipe and an Advanced one for correspondance.
   */
  public static boolean compareRecipes(Recipe o1, AdvRecipe o2) {
    if (!(o1 instanceof ShapedRecipe)) {
      return false;
    }
  ...
  /**
   * Splits a longer String into a list of smaller Strings.
   */
